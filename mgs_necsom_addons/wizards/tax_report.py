...
class TaxReport(models.TransientModel):
    _name = 'mgs_necsom_addons.tax_report'
    ...
    def confirm(self):
        ...
        return self.env.ref('mgs_necsom_addons.action_mgs_tax_report').report_action(self, data=data)

    # def export_to_excel(self):
    #     tax_report_report_obj = self.env['report.mgs_necsom_addons.tax_report_report']
...
class TaxReportReport(models.AbstractModel):
    _name = 'report.mgs_necsom_addons.tax_report_report'

...
class ReceiptAndPayment(models.TransientModel):
    _name = 'mgs_necsom_addons.receipt_and_payment'
    ...
    def confirm(self):
        ...
        return self.env.ref('mgs_necsom_addons.action_receipt_and_payment').report_action(self, data=data)

    def export_to_excel(self):
        receipt_and_payment_report_obj = self.env['report.mgs_necsom_addons.receipt_and_payment_report']
...
class ReceiptAndPaymentReport(models.AbstractModel):
    _name = 'report.mgs_necsom_addons.receipt_and_payment_report'

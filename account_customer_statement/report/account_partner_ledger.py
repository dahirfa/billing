...
class ReportPartnerLedger_statement(models.AbstractModel):
    ...
    def _lines(self, data, partner):
        ...
        params = [partner.id, data['computed']['move_state'], data['computed']['account_ids']] + query_get_data[2]
        ...
        for r in res:
            ...
            r['a_code'] = next(iter(r['a_code'].values()))
...
#     def render_html(self, doc_ids, data):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        reconcile_clause = "" if data['form'].get('reconciled', False) else ' AND aml.reconciled = false '

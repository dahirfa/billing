...
class ResCompanys(models.Model):
    ...
    mgs_unknown_partner_id = fields.Many2one('res.partner', string='Default Unknown Partner')
...
class ResConfigSettings(models.TransientModel):
    ...
    mgs_unknown_partner_id = fields.Many2one('res.partner', string='Default Unknown Partner', related="company_id.mgs_unknown_partner_id", readonly=False)

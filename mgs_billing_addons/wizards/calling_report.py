...
class CallingReport(models.TransientModel):
    _name = 'mgs_billing_addons.calling_report_wiz'
    ...
    def confirm(self):
        ...
        return self.env.ref('mgs_billing_addons.action_calling_report').report_action(self, data=data)

    def export_to_excel(self):
        calling_report_report_obj = self.env['report.mgs_billing_addons.calling_report_report']
...
class CallingReportReport(models.AbstractModel):
    _name = 'report.mgs_billing_addons.calling_report_report'
